...
second_article = Article.create!({
    ...
    lead: '<p>En el último año, de los <strong>7.237</strong> contratos adjudicados, solo 2.889 lo fueron vía concurso abierto</p><div id="home-chart" class="stacked-bar-chart"></div>',
    author: eva,
